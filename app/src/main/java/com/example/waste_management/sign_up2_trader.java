...
public class sign_up2_trader extends AppCompatActivity {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mobile_num)) {
                    ...
                    Toast.makeText(sign_up2_trader.this, "Enter a valid mobile number", Toast.LENGTH_SHORT).show();
                } else {
        ...
        PhoneAuthOptions.Builder builder = new PhoneAuthOptions.Builder(mAuth)
                ...
                .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        Toast.makeText(sign_up2_trader.this, "Failed to authenticate", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        ...
                        Toast.makeText(sign_up2_trader.this, "OTP Sent Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(sign_up2_trader.this, "Sign-up Successful", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent = new Intent(sign_up2_trader.this, Video_Activity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        // Verification failed
                        Toast.makeText(sign_up2_trader.this, "Verification failed. Please try again.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
